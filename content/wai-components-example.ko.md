...
github:
  ...
  path: content/wai-components-example.ko.md # Add the language shortcode to the middle of the filename, for example: content/index.fr.md

permalink: /fundamentals/components/examples/ko # Add the language shortcode to the end, with no slash at the end. For example /path/to/file/fr
